// ts2fable 0.7.1 -- with quite a few manual modifications, most of this probably doesn't work. ts2fable seems brittle.
module rec Manifest
open System
open Fable.Core
open Fable.Core.JS
open Filesystem.Index
open Browser.Types
...
module Chrome =
    let [<Emit("chrome.accessibilityFeatures")>]accessibilityFeatures: AccessibilityFeatures.IExports = jsNative
    let [<Emit("chrome.action")>]action: Action.IExports = jsNative
    let [<Emit("chrome.alarms")>]alarms: Alarms.IExports = jsNative
    let [<Emit("chrome.browser")>]browser: Browser.IExports = jsNative
    let [<Emit("chrome.bookmarks")>]bookmarks: Bookmarks.IExports = jsNative
    let [<Emit("chrome.browserAction")>]browserAction: BrowserAction.IExports = jsNative
    let [<Emit("chrome.browsingData")>]browsingData: BrowsingData.IExports = jsNative
    let [<Emit("chrome.commands")>]commands: Commands.IExports = jsNative
    let [<Emit("chrome.contentSettings")>]contentSettings: ContentSettings.IExports = jsNative
    let [<Emit("chrome.contextMenus")>]contextMenus: ContextMenus.IExports = jsNative
    let [<Emit("chrome.cookies")>]cookies: Cookies.IExports = jsNative
    let [<Emit("chrome._debugger")>]_debugger: _debugger.IExports = jsNative
    let [<Emit("chrome.declarativeContent")>]declarativeContent: DeclarativeContent.IExports = jsNative
    let [<Emit("chrome.declarativeWebRequest")>]declarativeWebRequest: DeclarativeWebRequest.IExports = jsNative
    let [<Emit("chrome.desktopCapture")>]desktopCapture: DesktopCapture.IExports = jsNative
    let [<Emit("chrome.documentScan")>]documentScan: DocumentScan.IExports = jsNative
    let [<Emit("chrome.downloads")>]downloads: Downloads.IExports = jsNative
    let [<Emit("chrome.extension")>]extension: Extension.IExports = jsNative
    let [<Emit("chrome.fileBrowserHandler")>]fileBrowserHandler: FileBrowserHandler.IExports = jsNative
    let [<Emit("chrome.fileSystemProvider")>]fileSystemProvider: FileSystemProvider.IExports = jsNative
    let [<Emit("chrome.fontSettings")>]fontSettings: FontSettings.IExports = jsNative
    let [<Emit("chrome.gcm")>]gcm: Gcm.IExports = jsNative
    let [<Emit("chrome.history")>]history: History.IExports = jsNative
    let [<Emit("chrome.i18n")>]i18n: I18n.IExports = jsNative
    let [<Emit("chrome.identity")>]identity: Identity.IExports = jsNative
    let [<Emit("chrome.idle")>]idle: Idle.IExports = jsNative
    let [<Emit("chrome.loginState")>]loginState: LoginState.IExports = jsNative
    let [<Emit("chrome.management")>]management: Management.IExports = jsNative
    let [<Emit("chrome.notifications")>]notifications: Notifications.IExports = jsNative
    let [<Emit("chrome.omnibox")>]omnibox: Omnibox.IExports = jsNative
    let [<Emit("chrome.pageAction")>]pageAction: PageAction.IExports = jsNative
    let [<Emit("chrome.pageCapture")>]pageCapture: PageCapture.IExports = jsNative
    let [<Emit("chrome.permissions")>]permissions: Permissions.IExports = jsNative
    //let [<Emit("chrome.platformKeys")>]platformKeys: PlatformKeys.IExports = jsNative
    let [<Emit("chrome.power")>]power: Power.IExports = jsNative
    let [<Emit("chrome.printerProvider")>]printerProvider: PrinterProvider.IExports = jsNative
    let [<Emit("chrome.privacy")>]privacy: Privacy.IExports = jsNative
    let [<Emit("chrome.proxy")>]proxy: Proxy.IExports = jsNative
    let [<Emit("chrome.search")>]search: Search.IExports = jsNative
    let [<Emit("chrome.serial")>]serial: Serial.IExports = jsNative
    let [<Emit("chrome.runtime")>]runtime: Runtime.IExports = jsNative
    let [<Emit("chrome.scripting")>]scripting: Scripting.IExports = jsNative
    let [<Emit("chrome.scriptBadge")>]scriptBadge: ScriptBadge.IExports = jsNative
    let [<Emit("chrome.sessions")>]sessions: Sessions.IExports = jsNative
    let [<Emit("chrome.storage")>]storage: Storage.IExports = jsNative
    let [<Emit("chrome.socket")>]socket: Socket.IExports = jsNative
    //let [<Emit("chrome.tabCapture")>]tabCapture: TabCapture.IExports = jsNative
    let [<Emit("chrome.tabs")>]tabs: Tabs.IExports = jsNative
    let [<Emit("chrome.tabGroups")>]tabGroups: TabGroups.IExports = jsNative
    let [<Emit("chrome.topSites")>]topSites: TopSites.IExports = jsNative
    let [<Emit("chrome.tts")>]tts: Tts.IExports = jsNative
    let [<Emit("chrome.ttsEngine")>]ttsEngine: TtsEngine.IExports = jsNative
    let [<Emit("chrome.vpnProvider")>]vpnProvider: VpnProvider.IExports = jsNative
    let [<Emit("chrome.wallpaper")>]wallpaper: Wallpaper.IExports = jsNative
    let [<Emit("chrome.webNavigation")>]webNavigation: WebNavigation.IExports = jsNative
    let [<Emit("chrome.webRequest")>]webRequest: WebRequest.IExports = jsNative
    let [<Emit("chrome.webstore")>]webstore: Webstore.IExports = jsNative
    let [<Emit("chrome.windows")>]windows: Windows.IExports = jsNative
    let [<Emit("chrome.declarativeNetRequest")>]declarativeNetRequest: DeclarativeNetRequest.IExports = jsNative
    ...
    module Action =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <summary>Since Chrome 91.
            /// Returns the user-specified settings relating to an extension's action.</summary>
            /// <param name="callback">The callback parameter should be a function that looks like this:
            /// (userSettings: UserSettings) => {...}</param>
            abstract getUserSettings: callback: (UserSettings -> unit) -> unit
            /// Since Chrome 91.
            /// Returns the user-specified settings relating to an extension's action.
            abstract getUserSettings: unit -> Promise<UserSettings>
            /// Since Chrome 88.
        ...
        type [<AllowNullLiteral>] UserSettings =
            ...
            abstract isOnToolbar: bool with get, set
    ...
    module BrowsingData =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract removeCookiesAsync: options: RemovalOptions * ?callback: (unit -> unit) -> Promise<unit>
            /// <summary>Clears the browser's cookies and server-bound certificates modified within a particular timeframe.</summary>
            /// <param name="callback">Called when the browser's cookies and server-bound certificates have been cleared.
            /// If you specify the callback parameter, it should be a function that looks like this:
            /// function() {...};</param>
    ...
    module Identity =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <param name="callback">Optional. Called with the URL redirected back to your application.
            /// The callback parameter should be a function that looks like this:
            /// function(string responseUrl) {...};</param>
            abstract launchWebAuthFlow: details: WebAuthFlowOptions * callback: (string -> unit) -> unit
            abstract launchWebAuthFlow: details: WebAuthFlowOptions -> Promise<string option>
    ...
    module Input =
        let [<Emit("chrome.ime")>]ime: Ime.IExports = jsNative
    ...
    module Networking =
        let [<Emit("chrome.config")>]config: Config.IExports = jsNative
    ...
    module Serial =
        let [<Emit("chrome.onReceive")>]onReceive: OnReceive.IExports = jsNative
        let [<Emit("chrome.onReceiveError")>]onReceiveError: OnReceiveError.IExports = jsNative
    ...
    module Runtime =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract sendMessage: extensionId: string option * message: 'M * responseCallback: ('R -> unit) -> unit
            /// <summary>Sends a single message to event listeners within your extension/app or a different extension/app. Similar to runtime.connect but only sends a single message, with an optional response. If sending to your extension, the runtime.onMessage event will be fired in each page, or runtime.onMessageExternal, if a different extension. Note that extensions cannot send messages to content scripts using this method. To send messages to content scripts, use tabs.sendMessage.</summary>
            /// <param name="extensionId">The ID of the extension/app to send the message to. If omitted, the message will be sent to your own extension/app. Required if sending messages from a web page for web messaging.
            /// Parameter response: The JSON response object sent by the handler of the message. If an error occurs while connecting to the extension, the callback will be called with no arguments and runtime.lastError will be set to the error message.</param>
            abstract sendMessage: extensionId: string option * message: 'Message * options: MessageOptions * responseCallback: ('Response -> unit) -> unit
            /// Sends a single message to event listeners within your extension/app or a different extension/app. Similar to runtime.connect but only sends a single message, with an optional response. If sending to your extension, the runtime.onMessage event will be fired in each page, or runtime.onMessageExternal, if a different extension. Note that extensions cannot send messages to content scripts using this method. To send messages to content scripts, use tabs.sendMessage.
            ...
            abstract sendMessage: extensionId: string option * message: 'M -> Promise<'R>
            /// <summary>Sends a single message to event listeners within your extension/app or a different extension/app. Similar to runtime.connect but only sends a single message, with an optional response. If sending to your extension, the runtime.onMessage event will be fired in each page, or runtime.onMessageExternal, if a different extension. Note that extensions cannot send messages to content scripts using this method. To send messages to content scripts, use tabs.sendMessage.</summary>
            /// <param name="extensionId">The ID of the extension/app to send the message to. If omitted, the message will be sent to your own extension/app. Required if sending messages from a web page for web messaging.</param>
            abstract sendMessage: extensionId: string option * message: 'Message * options: MessageOptions -> Promise<'Response>
        ...
        type [<AllowNullLiteral>] ExtensionMessageEvent =
            inherit Chrome.Events.Event<(obj option * MessageSender * (obj -> unit) -> unit)>
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] ManifestPermissions =
            ...
            | History
            | Identity
            | [<CompiledName "identity.email">] Identity_email
            | Idle
            | LoginState
            | Management
            | NativeMessaging
    ...
    module Scripting =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <param name="injection">The details of the styles to remove.
            /// Note that the css, files, and origin properties must exactly match the stylesheet inserted through `insertCSS`.
            /// Attempting to remove a non-existent stylesheet is a no-op.</param>
            abstract removeCSS: injection: CSSInjection -> Promise<unit>
            /// <summary>Removes a CSS stylesheet that was previously inserted by this extension from a target context.</summary>
            /// <param name="injection">The details of the styles to remove.
            /// Note that the css, files, and origin properties must exactly match the stylesheet inserted through `insertCSS`.
            /// Attempting to remove a non-existent stylesheet is a no-op.</param>
            /// <param name="callback">Invoked upon completion of the removal.</param>
            abstract removeCSS: injection: CSSInjection * ?callback: (unit -> unit) -> unit
            /// Registers one or more content scripts.
            abstract registerContentScripts: scripts: ResizeArray<RegisteredContentScript> -> Promise<unit>
            /// Registers one or more content scripts.
            abstract registerContentScripts: scripts: ResizeArray<RegisteredContentScript> * ?callback: (unit -> unit) -> unit
            /// Unregister one or more content scripts.
            abstract unregisterContentScripts: ?filter: ContentScriptFilter -> Promise<unit>
            /// Unregister one or more content scripts.
            abstract unregisterContentScripts: ?filter: ContentScriptFilter * ?callback: (unit -> unit) -> unit
            ...
            abstract getRegisteredContentScripts: ?filter: ContentScriptFilter -> Promise<ResizeArray<RegisteredContentScript>>
            /// Returns all the content scripts registered with scripting.registerContentScripts()
            /// or a subset of the registered scripts when using a filter.
            abstract getRegisteredContentScripts: ?filter: ContentScriptFilter * ?callback: (ResizeArray<RegisteredContentScript> -> unit) -> unit
        ...
        type Awaited<'T> = CC of obj // This is most probably broken

        type [<AllowNullLiteral>] RegisteredContentScript =
            abstract id: string with get, set
            abstract allFrames: bool option with get, set
            abstract css: ResizeArray<string> option with get, set
            abstract excludeMatches: ResizeArray<string> option with get, set
            abstract js: ResizeArray<string> option with get, set
            abstract matches: ResizeArray<string> option with get, set
            abstract persistAcrossSessions: bool option with get, set
            abstract runAt: RegisteredContentScriptRunAt option with get, set
            abstract world: ExecutionWorld option with get, set

        type [<AllowNullLiteral>] ContentScriptFilter =
            abstract ids: ResizeArray<string> option with get, set
            abstract css: string option with get, set
            abstract files: ResizeArray<string> option with get, set
            abstract origin: StyleOrigin option with get, set
            abstract target: InjectionTarget option with get, set

        type [<StringEnum>] [<RequireQualifiedAccess>] RegisteredContentScriptRunAt =
            | Document_start
            | Document_end
            | Document_idle
    ...
    module Storage =
        ...
        type [<AllowNullLiteral>] IExports =
            abstract AccessLevel: IExportsAccessLevel
        ...
        type [<AllowNullLiteral>] StorageArea =
            ...
            abstract set: items: StorageAreaSetItems -> Promise<unit>
            /// <summary>Sets multiple items.</summary>
            /// <param name="items">An object which gives each key/value pair to update storage with. Any other key/value pairs in storage will not be affected.
            /// Primitive values such as numbers will serialize as expected. Values with a typeof "object" and "function" will typically serialize to {}, with the exception of Array (serializes as expected), Date, and Regex (serialize using their String representation).</param>
            /// <param name="callback">Optional.
            ...
            abstract get: ?keys: U3<string, ResizeArray<string>, StorageAreaGet> -> Promise<StorageAreaGet>
            /// <summary>Gets one or more items from storage.</summary>
            /// <param name="keys">A single key to get, list of keys to get, or a dictionary specifying default values.
            /// An empty list or object will return an empty result object. Pass in null to get the entire contents of storage.</param>
            /// <param name="callback">Callback with storage items, or on failure (in which case runtime.lastError will be set).
            /// Parameter items: Object with items in their key-value mappings.</param>
            abstract get: keys: U3<string, ResizeArray<string>, StorageAreaGet> option * callback: (StorageAreaGet -> unit) -> unit
            /// <summary>Sets the desired access level for the storage area. The default will be only trusted contexts.</summary>
            /// <param name="accessOptions">An object containing an accessLevel key which contains the access level of the storage area.</param>
            abstract setAccessLevel: accessOptions: StorageAreaSetAccessLevelAccessOptions -> Promise<unit>
            /// <summary>Sets the desired access level for the storage area. The default will be only trusted contexts.</summary>
            /// <param name="accessOptions">An object containing an accessLevel key which contains the access level of the storage area.</param>
            /// <param name="callback">Optional.</param>
            abstract setAccessLevel: accessOptions: StorageAreaSetAccessLevelAccessOptions_ * callback: (unit -> unit) -> unit
            /// Fired when one or more items change within this storage area.
            abstract onChanged: StorageAreaChangedEvent with get, set
        ...
        type [<AllowNullLiteral>] StorageAreaSetAccessLevelAccessOptions =
            abstract accessLevel: AccessLevel with get, set

        type [<AllowNullLiteral>] StorageAreaSetAccessLevelAccessOptions_ =
            abstract accessLevel: AccessLevel with get, set
        ...
        type [<AllowNullLiteral>] StorageAreaChangedEvent =
            inherit Chrome.Events.Event<(StorageAreaChangedEventChromeEventsEvent -> unit)>

        type AreaName =
            obj

        type [<AllowNullLiteral>] StorageChangedEvent =
            inherit Chrome.Events.Event<(StorageAreaChangedEventChromeEventsEvent -> AreaName -> unit)>

        type AccessLevel =
            obj

        type [<AllowNullLiteral>] IExportsAccessLevel =
            abstract TRUSTED_AND_UNTRUSTED_CONTEXTS: string with get, set
            abstract TRUSTED_CONTEXTS: string with get, set

        type [<AllowNullLiteral>] StorageAreaGet =
            [<Emit "$0[$1]{{=$2}}">] abstract Item: key: string -> obj option with get, set

        type [<AllowNullLiteral>] StorageAreaChangedEventChromeEventsEvent =
    ...
    module System =
        let [<Emit("chrome.cpu")>]cpu: Cpu.IExports = jsNative
        let [<Emit("chrome.memory")>]memory: Memory.IExports = jsNative
        let [<Emit("chrome.storage")>]storage: Storage.IExports = jsNative
        let [<Emit("chrome.display")>]display: Display.IExports = jsNative
    ...
    module Tabs =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// Sends a single message to the content script(s) in the specified tab, with an optional callback to run when a response is sent back. The runtime.onMessage event is fired in each content script running in the specified tab for the current extension.
            abstract sendMessage: tabId: float * message: 'M -> Promise<'R>
            /// Sends a single message to the content script(s) in the specified tab, with an optional callback to run when a response is sent back. The runtime.onMessage event is fired in each content script running in the specified tab for the current extension.
            abstract sendMessage: tabId: float * message: 'M * options: MessageSendOptions -> Promise<'R>
        ...
        type [<AllowNullLiteral>] TabUpdatedEvent =
            inherit Chrome.Events.Event<(float -> TabChangeInfo -> Tab -> unit)>
    ...
    module TopSites =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// Gets a list of top sites.
            abstract get: unit -> Promise<ResizeArray<MostVisitedURL>>
    ...
    module Tts =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract getVoices: unit -> Promise<ResizeArray<TtsVoice>>
        ...
        type [<AllowNullLiteral>] TtsEvent =
            ...
            abstract ``type``: TtsEventType with get, set
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] TtsEventType =
            | Start
            | End
            | Word
            | Sentence
    ...
    module WebRequest =
        ...
        type [<AllowNullLiteral>] WebRequestHeadersDetails =
            ...
            abstract requestHeaders: ResizeArray<HttpHeader> option with get, set
            abstract documentId: string with get, set
            abstract documentLifecycle: WebRequestHeadersDetailsDocumentLifecycle with get, set
            abstract frameType: WebRequestHeadersDetailsFrameType with get, set
            /// The value 0 indicates that the request happens in the main frame; a positive value indicates the ID of a subframe in which the request happens. If the document of a (sub-)frame is loaded (type is main_frame or sub_frame), frameId indicates the ID of this frame, not the ID of the outer frame. Frame IDs are unique within a tab.
            abstract frameId: float with get, set
            /// The origin where the request was initiated. This does not change through redirects. If this is an opaque origin, the string 'null' will be used.
            abstract initiator: string option with get, set
            abstract parentDocumentId: string option with get, set
            /// ID of frame that wraps the frame which sent the request. Set to -1 if no parent frame exists.
            abstract parentFrameId: float with get, set
            /// The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to relate different events of the same request.
            abstract requestId: string with get, set
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] WebRequestHeadersDetailsDocumentLifecycle =
            | Prerender
            | Active
            | Cached
            | Pending_deletion

        type [<StringEnum>] [<RequireQualifiedAccess>] WebRequestHeadersDetailsFrameType =
            | Outermost_frame
            | Fenced_frame
            | Sub_frame
